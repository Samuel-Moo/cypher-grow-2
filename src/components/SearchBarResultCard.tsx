...
function SearchBarResultCard() {
  return (
    <>
            <div className="!z-5 relative flex flex-col rounded-[20px] max-w-[300px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 
             w-full !p-4 3xl:p-![18px] undefined">
                <div className="h-full w-full">
                    <div className="relative w-full">
                        <Image src="/temp.jpg" width={5184 / 10} height={3888 / 10} className="mb-3 h-full w-full rounded-xl 3xl:h-full 3xl:w-full" alt=""/>
                    ...
                    <div className="mb-3 flex items-center justify-between px-1 md:items-start">
                        <div className="mb-2">
                            <p className="text-lg font-bold text-navy-700"> Persona promedio </p>
                            <p className="mt-1 text-sm font-medium text-gray-600 md:mt-2">algo </p>
                        </div>
                    ...
                    <div className="flex items-center justify-between md:items-center lg:justify-between ">
                        <div className="flex">
                            <p className="!mb-0 text-sm font-bold text-brand-500">Current Bid: 0.91 <span>SOL</span></p>
                        </div>
                        <button  className="linear rounded-[20px] bg-brand-900 px-4 py-2 text-base font-medium text-black transition duration-200 hover:bg-black hover:text-white active:bg-brand-700">Subscribe</button>
                    </div>
                </div>
            </div>
    </>
